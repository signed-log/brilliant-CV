...
| `just test` | Before committing | Full suite: tytanic visual, panic smoke, query hooks, extracted-text snapshots, and PDF/UA-1 starter checks. Needs a running Docker daemon |
